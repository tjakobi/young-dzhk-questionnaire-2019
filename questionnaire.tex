...
\vspace{0.2cm}
    ...
    \end{choicegroup}
            ...
            \textbox{4cm}{Do you have any comments on the / to the Young-DZHK committee?}
...
following statements.}
      ...
      % After that it is possible to add each question.
      \choiceline{The quality of the keynote by \textbf{Katey Rayner} was appropriate.}
\vspace{0.2cm}
      % After that it is possible to add each question.
      \choiceline{The quality of the keynote by \textbf{Linda van Laake} was appropriate.}
\vspace{0.2cm}
      \choiceline{The quality of the keynote by \textbf{Florian Leuschner} was appropriate.}
\vspace{0.2cm}
\end{choicegroup}
            
            \textbox{4cm}{Do you have any recommendations for keynote speakers for the next year's Young-DZHK Retreat?}
